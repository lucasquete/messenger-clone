...
const ConversationList = ({ conversations, users }) => {
    ...
    useEffect(() => {
        ...
        pusherClient.subscribe(phuserKey);
        ...
        return () => {
            pusherClient.unsubscribe(phuserKey);
            pusherClient.unbind("conversation:new", newHandler);
            pusherClient.unbind("conversation:update", updateHandler);
            pusherClient.unbind("conversation:remove", removeHandler);
        }
    }, [phuserKey, conversationId, router])
